...
**Giới thiệu**:
Blitzkrieg là một trò chơi chiến thuật hành động, sinh tồn, thắng bại tại kĩ năng lấy cảm hứng từ các cuộc chiến tranh thế giới. 
Hai anh em ngồi trên hai xe tank khác nhau và bắn ra những cục kẹo (đồng). Ai ăn trúng kẹo (đồng) sẽ thua. 
Bản đồ sẽ được tạo ra liên tục để tăng tính thú vị cho trò chơi.

**Cách chơi**:
1. Nhấn "Play Game".
2. Chọn chế độ:
   - **Ở chế độ PvP**:
     - P1: W - Lên, A - Trái, S - Xuống, D - Phải, E - Bắn
...
- Dung lượng: ~25MB (file .exe)
- Không cần cài đặt Python hoặc Pygame, chỉ cần chạy file `Blitzkrieg.exe`.

**Tính năng đặc biệt**:
Trong game có một tính năng đặc biệt khi bắn súng. Đây là tính năng và không phải "bọ".

**Phiên bản**:
Vì đây là phiên bản Beta 1.0.5e, vui lòng liên hệ cho chúng tôi khi bạn phát hiện ra những "con bọ" bay vào trò chơi này. Xin cảm ơn!

  Cập nhật
===========================

**Beta 1.0.1**: (18/02/2025 - by dnk, tmh9)
...
**Beta 1.0.5e**: (02/03/2025 - by dnk) -- **Latest verion**
  - Nâng cấp giao diện người dùng.
